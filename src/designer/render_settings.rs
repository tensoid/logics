...
pub struct CircuitBoardRenderingSettings {
    ...
    pub board_entity_edge_radius: f32,
    pub board_binary_io_pin_radius: f32,
    pub board_binary_io_color: Color,
    pub board_binary_input_extents: Vec2,
    pub board_binary_output_extents: Vec2,
    pub board_binary_io_display_font_size: f32,
...
pub fn init_render_settings(app: &mut App) {
    ...
    let render_settings = CircuitBoardRenderingSettings {
        ...
        board_entity_edge_radius: 5.0,
        board_binary_io_pin_radius: 7.0,
        board_binary_io_color: WHITE.into(),
        board_binary_input_extents: Vec2::new(60.0, 30.0),
        board_binary_output_extents: Vec2::new(30.0, 30.0),
        board_binary_io_display_font_size: 15.0,
        wire_line_width: 2.0,
